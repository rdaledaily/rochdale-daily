...
DISCOVERY_PAGES = [
    ...
    {'name': 'Greater Manchester Police', 'url': 'https://www.gmp.police.uk/news/', 'default_area': 'rochdale', 'default_category': 'crime', 'page_limit': 12, 'link_pattern': '/news/'},
...
DISCOVERY_LISTING_OVERRIDES = {'Groundwork Greater Manchester': ['https://www.groundwork.org.uk/greatermanchester/latest/', 'https://www.groundwork.org.uk/greatermanchester/latest/?query-6-page=2'], 'Rochdale Borough Council News': ['https://www.rochdale.gov.uk/news', 'https://www.rochdale.gov.uk/news?page=2', 'https://www.rochdale.gov.uk/news?page=3'], 'Rochdale Council Events': ['https://www.rochdale.gov.uk/events?page=1', 'https://www.rochdale.gov.uk/events?page=2', 'https://www.rochdale.gov.uk/events?page=3'], 'Rochdale Town Hall Events': ['https://www.rochdaletownhall.co.uk/events?page=1', 'https://www.rochdaletownhall.co.uk/events?page=2', 'https://www.rochdaletownhall.co.uk/events?page=3'], 'Greater Manchester Police': [*[f'https://www.gmp.police.uk/news/news-search/?ct=News&fdte=&page={page}&tdte=' for page in range(1, 9)], *[f'https://www.gmp.police.uk/news/news-search/?ct=Appeals&fdte=&page={page}&tdte=' for page in range(1, 5)]], 'Roch Valley Radio Local News': ['https://www.rochvalleyradio.com/news/local-news/', 'https://www.rochvalleyradio.com/news/local-news/?page=2', 'https://www.rochvalleyradio.com/news/local-news/?page=3']}
