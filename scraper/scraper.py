...
LOCAL_TERMS = {
    ...
    "blackley", "belfield", "wardleworth", "sudden", "buersil",
    "cloverhall", "lowerplace", "meanwood", "mandale park",
    "summit", "hollingworth lake", "slattocks", "birch",
}

AREA_KEYWORDS = {
    # Specific neighbourhoods must appear before broader township names.
    "darnhill": {"darnhill"},
    "hopwood": {"hopwood"},
    ...
    "schema": {
        ...
        "properties": {
            ...
            "area": {
                "type": "string",
                "enum": [
                    "rochdale", "heywood", "middleton", "littleborough",
                    "milnrow", "newhey", "wardle", "smallbridge",
                    "smithy_bridge", "whitworth", "norden", "bamford",
                    "cutgate", "kirkholt", "castleton", "spotland",
                    "falinge", "deeplish", "balderstone", "firgrove",
                    "shawclough", "healey", "syke", "darnhill", "hopwood",
                    "alkrington", "langley", "boarshaw", "wardleworth",
